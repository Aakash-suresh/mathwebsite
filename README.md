...
To design a static website with validation to perform mathematical calculations for the Area of a Circle and Rectangle in client side.
...
writing javascript to perform the calculations.

### Step 4:

Including the regularexpression for Calculating the Area of a Circle and Rectangle.
...
Thus a website is designed to perform mathematical calculations for  the Area of a Circle and Rectangle in client side.
